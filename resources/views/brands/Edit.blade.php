<x-app-layout>
    ...
    <style>
        ...
        .nw-form-card { max-width: 560px; margin: 0 auto; }
        ...
        .nw-input:focus, .nw-textarea:focus {
            ...
            <div class="nw-form-card">
                <div class="overflow-hidden bg-white">
                    ...
                    <div class="nw-card-header">
                        ...
                        <h2 class="nw-card-heading">Edit Brand</h2>
                        <span class="nw-card-id">ID #{{ $brand->brandId }}</span>
                    </div>

                    <div class="nw-form-body">
                        <form method="POST" action="/brands/update/{{ $brand->brandId }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="nw-form-actions">
                                ...
                                <button type="submit" class="nw-btn-submit">Update Brand</button>
                            </div>
                        </form>
                    </div>
