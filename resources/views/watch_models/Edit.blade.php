<x-app-layout>
    ...
    <style>
        ...
        .nw-form-card { max-width: 620px; margin: 0 auto; }
            ...
            <div class="nw-form-card">
                <div class="overflow-hidden bg-white">
                    ...
                    <div class="nw-card-header">
                        ...
                        <h2 class="nw-card-heading">Edit Watch Model</h2>
                        <span class="nw-card-id">ID #{{ $watchModel->modelId }}</span>
                    </div>

                    <div class="nw-form-body">
                        <form method="POST" action="/watch-models/update/{{ $watchModel->modelId }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="nw-grid-2">
                                    ...
                                    <div class="nw-select-wrap">
                                        <select id="brandId" name="brandId" class="nw-select" required>
                                            ...
                                            @foreach($brands as $brand)
                                                <option value="{{ $brand->brandId }}" {{ old('brandId', $watchModel->brandId) == $brand->brandId ? 'selected' : '' }}>
                                                    {{ $brand->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="nw-field">
                                    ...
                                    <input type="text" id="model_name" name="model_name" class="nw-input"
                                        value="{{ old('model_name', $watchModel->model_name) }}"
                                ...
                                <div class="nw-field">
                                    ...
                                    <input type="text" id="reference_number" name="reference_number" class="nw-input"
                                        value="{{ old('reference_number', $watchModel->reference_number) }}"
                                        maxlength="50">
                            ...
                            <div class="nw-grid-2">
                                ...
                                <div class="nw-field">
                                    ...
                                    <input type="number" id="year" name="year" class="nw-input"
                                        value="{{ old('year', $watchModel->year) }}"
                                        min="1800" max="{{ date('Y') }}">
                                ...
                                <div class="nw-field">
                                    ...
                                    <div class="nw-select-wrap">
                                        <select id="movement_type" name="movement_type" class="nw-select">
                                            ...
                                            <option value="manual"    {{ old('movement_type', $watchModel->movement_type) === 'manual'    ? 'selected' : '' }}>Manual</option>
                                            <option value="automatic" {{ old('movement_type', $watchModel->movement_type) === 'automatic' ? 'selected' : '' }}>Automatic</option>
                                            <option value="quartz"    {{ old('movement_type', $watchModel->movement_type) === 'quartz'    ? 'selected' : '' }}>Quartz</option>
                                        </select>
                                    </div>
                                ...
                                <div class="nw-field nw-field-full">
                                    ...
                                    <textarea id="desc" name="desc" class="nw-textarea" maxlength="150">{{ old('desc', $watchModel->desc) }}</textarea>
                                ...
                                <div class="nw-field nw-field-full">
                                    ...
                                    <input type="text" id="image" name="image" class="nw-input"
                                        value="{{ old('image', $watchModel->image) }}"
                                        maxlength="255">
                            ...
                            <div class="nw-form-actions">
                                ...
                                <button type="submit" class="nw-btn-submit">Update Model</button>
                            </div>
                        </form>
                    </div>
